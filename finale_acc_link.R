...
berlinstraﬂen_acc <- mutate(berlinstraﬂen_acc, "accident rate" = (1000000*acc)/(365*count*length))
berlinstraﬂen_acc$"accident rate" <- as.numeric(berlinstraﬂen_acc$"accident rate")
berlinstraﬂen_acc <- filter(berlinstraﬂen_acc, "accident rate" > 0)
berlinstraﬂen_acc <- filter(berlinstraﬂen_acc, !is.na("accident rate"))
